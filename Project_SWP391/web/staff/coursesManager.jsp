                                ...
                                <table style="border: 1">
                                    ...
                                    <c:forEach items="${data}" var="c">
                                        <tr>
                                            <td>${c.getTitle()}</td>
                                            <td>${c.getNameCate()}</td>
                                            <td>${c.getNameTeacher()}</td>
                                            <td>$${c.getPrice()}-$${c.getPrice()*c.getDiscount()}</td>
                                            <td>${c.getStart()}</td>
                                            <td>
                                    <c:choose>
                                    ...
                                    <c:otherwise>
                                        ...
                                        <td>
                                            ...
                                            <td> <a href="staffupdatecourse?id=${c.id}" class="btn green radius-xl outline">Edit</a>
                                </td>
                                            <td><a href="staffdeletecourse?id=${c.id}" class="btn red outline radius-xl ">Delete</a></td>
