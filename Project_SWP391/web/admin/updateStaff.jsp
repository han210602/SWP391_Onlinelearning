            ...
            <div class="container-fluid">
                <div class="db-breadcrumb">
                    ...
                    <ul class="db-breadcrumb-list">
                        ...
                        <li><a href="manageStaffAccounts">Manage Staff</a></li>
                        <li>Update Staff</li>
                                        ...
                                        <form action="updateStaff" method="post">
                                            <ul>
                                                <li>
                                                    ...
                                                    <input type="hidden" value="${requestScope.id}" name="id"/></br>
                                                    <input type="text" value="${requestScope.a.username}" name="username"/></br>
                                                </li>
                                                <li>
                                                    <span class="orders-info">Password</span>&nbsp
                                                    <input type="text" value="${requestScope.a.pass}" name="pass"/></br>
                                                </li>
                                                <li>
                                                    <span class="orders-info">Email</span>&nbsp
                                                    <input type="text" value="${requestScope.a.email}" name="email"/></br>
                                                </li>
                                                <li>
                                                    <span class="orders-info">FullName</span>&nbsp
                                                    <input type="text" value="${requestScope.a.fullname}" name="fullname"/></br>
                                                </li>
                                                <li>
                                                    <span class="orders-info">Gender:</span>&nbsp;
                                                    <input type="radio" id="male" name="gender" value="1" ${requestScope.a.gender == 'Male' ? 'checked' : ''}/>
                                                    <label for="male">Male</label>&nbsp;
                                                    <input type="radio" id="female" name="gender" value="0" ${requestScope.a.gender == 'Female' ? 'checked' : ''}/>
                                                    <label for="female">Female</label></br>
                                                </li>
                                                <li>
                                                    <span class="orders-info">Address</span>&nbsp
                                                    <input type="text" value="${requestScope.a.address}" name="address"/></br>
                                                </li>
                                                <li>
                                                    <span class="orders-info">RoleId</span>&nbsp
                                                    <input type="text" value="${requestScope.a.roles_id}" name="roles_id"/></br>
                                                </li>
                                                <li>
                                                    <span class="orders-info">Img</span>&nbsp
                                                    <input type="text" value="${requestScope.a.imgUrl}" name="imgUrl"/></br>
                                                </li>
                                                <li>
