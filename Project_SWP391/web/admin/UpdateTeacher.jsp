                        ...
                        <div class="widget-box">
                            ...
                            <div class="widget-inner">
                                ...
                                <form action="teacherupdate" method="post" class="edit-profile m-b30">
                                    <input type="text" name="id" hidden="" value="${t.getId()}" >
                                    <div class="row">
                                        <div class="col-12">
                                            <div class="ml-auto">
                                                <h3>1. Account</h3>
                                        ...
                                        <div class="form-group col-6">
                                            ...
                                            <div>
                                                <input class="form-control" type="text" name="username" value="${t.getUsername()}"/>
                                            </div>
                                        </div>
                                        <div class="form-group col-6">
                                            <label class="col-form-label">Pass Word</label>
                                            <div>
                                                <input class="form-control" type="text" name="pass" value="${t.getPass()}"/>
                                            </div>
                                        </div>
                                        <div class="form-group col-6">
                                        ...
                                        <div class="form-group col-6">
                                            ...
                                            <div>
                                                <input class="form-control" type="text" name="address" value="${t.getAddress()}"/>
                                            </div>
                                        </div>
                                        <div class="form-group col-6">
                                            <label class="col-form-label">Subject</label>
                                            <div>
                                                <input class="form-control" type="text" name="subject" value="${t.getSubject()}"/>
                                            </div>
                                        </div>
                                        <div class="form-group col-6">
