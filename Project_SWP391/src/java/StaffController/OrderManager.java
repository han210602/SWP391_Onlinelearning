...
//            }
        ...
        int count=0;
        data=order.getListOrder(Integer.parseInt(request.getParameter("pageIndex")), pageSize);
        System.out.println(data.size());
        count=order.getTotalOrder();
        ...
        request.getRequestDispatcher("staff/ordermanager.jsp").forward(request, response);
